...
var $author$project$Renderers$WebGL$Renderer$AdjustTimeZone = function (a) {
...
var $author$project$Renderers$WebGL$Renderer$init = function (_v0) {
	return _Utils_Tuple2(
		...
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					A2($elm$core$Task$perform, $author$project$Renderers$WebGL$Renderer$AdjustTimeZone, $elm$time$Time$here)
				])));
};

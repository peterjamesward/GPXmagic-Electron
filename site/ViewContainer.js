...
var $author$project$Common$Layouts$newViewCmd = F2(
	function (window, view) {
		var _v0 = _Utils_Tuple2(
			window.leftToolboxVisible ? 300 : 30,
			window.rightToolboxVisible ? (window.width - 300) : (window.width - 30));
		var left = _v0.a;
		var right = _v0.b;
		var _v1 = _Utils_Tuple2((right - left) / 100, window.height / 100);
		var contentWidthPercent = _v1.a;
		var contentHeightPercent = _v1.b;
		var _v2 = _Utils_Tuple2((contentHeightPercent * view.topPercent) | 0, (contentHeightPercent * view.heightPercent) | 0);
		var viewTop = _v2.a;
		var viewHeight = _v2.b;
		var _v3 = _Utils_Tuple2(left + ((contentWidthPercent * view.leftPercent) | 0), (contentWidthPercent * view.widthPercent) | 0);
		var viewLeft = _v3.a;
		var viewWidth = _v3.b;
		return {height: viewHeight, left: viewLeft, rendererType: view.rendererType, top: viewTop, width: viewWidth};
	});
...
var $author$project$Common$Layouts$initViewCmd = _List_fromArray(
	[
		$author$project$Common$Layouts$leftToolbox,
...
var $author$project$Common$Layouts$newViewCmdAsJson = function (view) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'width',
				$elm$json$Json$Encode$int(view.width)),
				_Utils_Tuple2(
				'height',
				$elm$json$Json$Encode$int(view.height)),
				_Utils_Tuple2(
				'x',
				$elm$json$Json$Encode$int(view.left)),
				_Utils_Tuple2(
				'y',
...
var $author$project$Renderers$ViewContainer$IpcStubs$ipcMainToRenderer = _Platform_incomingPort('ipcMainToRenderer', $elm$json$Json$Decode$value);
var $author$project$Renderers$ViewContainer$Renderer$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$author$project$Renderers$ViewContainer$IpcStubs$ipcMainToRenderer($author$project$Renderers$ViewContainer$Renderer$MessageFromMainProcess)
			]));
};
...
var $author$project$Renderers$ViewContainer$Renderer$view = function (model) {
	return A2(
		...
		$mdgriffith$elm_ui$Element$text('Container ready'));
};
var $author$project$Renderers$ViewContainer$Renderer$main = $elm$browser$Browser$element(
	{init: $author$project$Renderers$ViewContainer$Renderer$init, subscriptions: $author$project$Renderers$ViewContainer$Renderer$subscriptions, update: $author$project$Renderers$ViewContainer$Renderer$update, view: $author$project$Renderers$ViewContainer$Renderer$view});
_Platform_export({'Renderers':{'ViewContainer':{'Renderer':{'init':$author$project$Renderers$ViewContainer$Renderer$main(

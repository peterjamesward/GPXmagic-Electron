...
var $author$project$Renderers$Proforma$Renderer$AdjustTimeZone = function (a) {
...
var $author$project$Renderers$Proforma$IpcStubs$ipcMainToRenderer = _Platform_incomingPort('ipcMainToRenderer', $elm$json$Json$Decode$value);
var $author$project$Renderers$Proforma$Renderer$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$author$project$Renderers$Proforma$IpcStubs$ipcMainToRenderer($author$project$Renderers$Proforma$Renderer$MessageFromMainProcess)
			]));
};
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Renderers$Proforma$Renderer$update = F2(
	function (msg, model) {
		if (msg.$ === 'AdjustTimeZone') {
			var newZone = msg.a;
			return _Utils_Tuple2(
				_Utils_update(
					model,
...
var $author$project$Renderers$Proforma$Renderer$view = function (model) {
	...
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$text('WebGL here')
				])));
};
var $author$project$Renderers$Proforma$Renderer$main = $elm$browser$Browser$element(
	{init: $author$project$Renderers$Proforma$Renderer$init, subscriptions: $author$project$Renderers$Proforma$Renderer$subscriptions, update: $author$project$Renderers$Proforma$Renderer$update, view: $author$project$Renderers$Proforma$Renderer$view});
_Platform_export({'Renderers':{'Proforma':{'Renderer':{'init':$author$project$Renderers$Proforma$Renderer$main(

...
var $author$project$Renderers$Toolbox$Renderer$AdjustTimeZone = function (a) {
...
var $author$project$Renderers$Toolbox$IpcStubs$ipcRendererToMain = _Platform_outgoingPort('ipcRendererToMain', $elm$core$Basics$identity);
...
var $author$project$Renderers$Toolbox$Renderer$init = function (_v0) {
	return _Utils_Tuple2(
		...
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					A2($elm$core$Task$perform, $author$project$Renderers$Toolbox$Renderer$AdjustTimeZone, $elm$time$Time$here),
					$author$project$Renderers$Toolbox$IpcStubs$ipcRendererToMain(
...
var $author$project$Renderers$Toolbox$Renderer$MessageFromMainProcess = function (a) {
	return {$: 'MessageFromMainProcess', a: a};
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$Renderers$Toolbox$IpcStubs$ipcMainToRenderer = _Platform_incomingPort('ipcMainToRenderer', $elm$json$Json$Decode$value);
var $author$project$Renderers$Toolbox$Renderer$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$author$project$Renderers$Toolbox$IpcStubs$ipcMainToRenderer($author$project$Renderers$Toolbox$Renderer$MessageFromMainProcess)
			]));
};
var $author$project$Renderers$Toolbox$Renderer$GpxLoaded = function (a) {
	return {$: 'GpxLoaded', a: a};
};
var $author$project$Renderers$Toolbox$Renderer$GpxSelected = function (a) {
...
var $author$project$Renderers$Toolbox$IpcStubs$loadNewGpx = function (pointsAsJSON) {
	return $author$project$Renderers$Toolbox$IpcStubs$ipcRendererToMain(
		$elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'cmd',
					$elm$json$Json$Encode$string('newgpx')),
...
var $author$project$Renderers$Toolbox$IpcStubs$newView = function (renderer) {
	return $author$project$Renderers$Toolbox$IpcStubs$ipcRendererToMain(
		$elm$json$Json$Encode$object(
			_List_fromArray(
				[
...
var $author$project$Common$GpxParser$asRegex = function (t) {
	return A2(
...
var $author$project$Common$GpxParser$deDupe = F2(
...
var $author$project$Common$GpxParser$parseGPXPoints = function (xml) {
	...
	var trkpts = A2(
		...
		$author$project$Common$GpxParser$asRegex('(<trkpt(.|\\s)*?)(trkpt>|\\/>)'),
		xml);
				...
				A2(
					...
					A2(
						...
						$elm$core$List$head(
							A2(
								$elm$regex$Regex$find,
								$author$project$Common$GpxParser$asRegex('<time>(.*)<\\/time>'),
								trkpt))))));
	};
	var sameLocation = F2(
		function (_v4, _v5) {
	...
	var longitude = function (trkpt) {
		return matches(
			A2(
				$elm$regex$Regex$find,
				$author$project$Common$GpxParser$asRegex('lon=\\\"([\\d\\.-]*)\\\"'),
				trkpt));
	};
	var latitude = function (trkpt) {
		return matches(
			A2(
				$elm$regex$Regex$find,
				$author$project$Common$GpxParser$asRegex('lat=\\\"([\\d\\.-]*)\\\"'),
				trkpt));
	};
	var elevation = function (trkpt) {
		var _v3 = matches(
			A2(
				$elm$regex$Regex$find,
				$author$project$Common$GpxParser$asRegex('<ele>([\\d\\.-]*)<\\/ele>'),
				trkpt));
		if (_v3.b && (_v3.a.$ === 'Just')) {
			var alt = _v3.a.a;
			return alt;
	...
	return A2(
		$author$project$Common$GpxParser$deDupe,
		sameLocation,
...
var $author$project$Common$GpxParser$parseSegments = function (xml) {
	var trackSegmentStarts = A2(
		...
		A2(
			$elm$regex$Regex$find,
			$author$project$Common$GpxParser$asRegex('<trkseg>'),
			xml));
	var trackPoints = $author$project$Common$GpxParser$parseGPXPoints(xml);
	...
	var namedSegments = A2(
		$elm$regex$Regex$find,
		$author$project$Common$GpxParser$asRegex('namedSegment>(.*)<\\/.*:namedSegment'),
		xml);
	return _Utils_Tuple2(
...
var $author$project$Renderers$Toolbox$Renderer$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'AdjustTimeZone':
				var newZone = msg.a;
			...
			case 'GpxRequested':
				return _Utils_Tuple2(
					...
					A2(
						...
						_List_fromArray(
							['text/gpx']),
						$author$project$Renderers$Toolbox$Renderer$GpxSelected));
			case 'GpxSelected':
				var file = msg.a;
				return _Utils_Tuple2(
					model,
					A2(
						$elm$core$Task$perform,
						$author$project$Renderers$Toolbox$Renderer$GpxLoaded,
						$elm$file$File$toString(file)));
			case 'GpxLoaded':
				var content = msg.a;
				var gpxPoints = $author$project$Common$GpxParser$parseSegments(content).a;
				return _Utils_Tuple2(
					model,
					$author$project$Renderers$Toolbox$IpcStubs$loadNewGpx(
						A2(
			...
			default:
				...
				return _Utils_Tuple2(
					model,
					$author$project$Renderers$Toolbox$IpcStubs$newView(rendererType));
		}
	});
var $author$project$Renderers$Toolbox$Renderer$GpxRequested = {$: 'GpxRequested'};
var $author$project$Renderers$Toolbox$Renderer$OpenView = function (a) {
	return {$: 'OpenView', a: a};
};
...
var $author$project$Renderers$Toolbox$Renderer$view = function (model) {
	...
	var loadGpxButton = A2(
		...
		buttonStyles,
		{
			...
			onPress: $elm$core$Maybe$Just($author$project$Renderers$Toolbox$Renderer$GpxRequested)
		});
	var openView = A2(
		$mdgriffith$elm_ui$Element$Input$button,
		buttonStyles,
		{
			...
			onPress: $elm$core$Maybe$Just(
				$author$project$Renderers$Toolbox$Renderer$OpenView($author$project$Common$RendererType$Renderer3D))
		});
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[$mdgriffith$elm_ui$Element$centerX, $mdgriffith$elm_ui$Element$centerY, $mdgriffith$elm_ui$Element$spaceEvenly]),
			_List_fromArray(
				[loadGpxButton, openView])));
};
var $author$project$Renderers$Toolbox$Renderer$main = $elm$browser$Browser$element(
	{init: $author$project$Renderers$Toolbox$Renderer$init, subscriptions: $author$project$Renderers$Toolbox$Renderer$subscriptions, update: $author$project$Renderers$Toolbox$Renderer$update, view: $author$project$Renderers$Toolbox$Renderer$view});
_Platform_export({'Renderers':{'Toolbox':{'Renderer':{'init':$author$project$Renderers$Toolbox$Renderer$main(
